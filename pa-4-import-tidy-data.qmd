...
```{r}
#| label: Fixing head
youth_fix_top <- read_csv("data-raw/YRBS2015.csv", skip = 1) # Skipping the top row names
```
...
youth_fix_missing <- read_csv("data-raw/YRBS2015.csv", skip = 1, c(".", "N/A")) # fixing missing values using na function
```
